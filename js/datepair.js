...
var DatePair = function (shouldSetToNow, dateTimeObjects, highlightAdvance) {
    ...
    this.startDate = $('#date-interval-date');
    this.startTime = $('#date-interval-time-start');
    this.endTime = $('#date-interval-time-end');
    ...
    this.initialize = function (shouldSetToNow) {
        ...
        {
            this.setToTime(new Date(window.vrijemePocetak),new Date(window.vrijemeKraj));
        }
    ...
    this.setToNow = function () {
        ...
        // Update widget state
        this.setToTime(now,inOneHour);
    };

    this.setToTime = function(start,end){
        this.setStartDateTime(start);
        this.setEndDateTime(end);
        this.updateEndTime(start - end);
    }
    ...
    this.getEndDateTime = function () {
        ...
        date = new Date(startDate.getTime()  + endSeconds * 1000);
        return date;
    };
...
// Initialize on load
$(function() {
    var datePair = new DatePair(window.jeNova);
});